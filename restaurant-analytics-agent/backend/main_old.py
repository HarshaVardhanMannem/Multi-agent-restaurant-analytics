...
from .config.constants import MAX_QUERY_TIMEOUT
...
async def process_query(
    ...
    try:
        ...
        logger.info(f"[{query_id}] Stream answer: {stream_answer}")
        ...
        # Non-streaming path - use query service
        logger.info(f"[{query_id}] Using non-streaming path")
